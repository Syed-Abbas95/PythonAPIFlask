pipeline {
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Syed-Abbas95/PythonAPIFlask.git', branch: 'main'
            }
        }
        ...
        stage('Push Docker Image to Docker Hub') {
            steps {
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: 'Abbas-dockerhub', usernameVariable: 'DOCKER_HUB_USERNAME', passwordVariable: 'DOCKER_HUB_PASSWORD')]) {
